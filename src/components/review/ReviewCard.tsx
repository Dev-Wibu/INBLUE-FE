...
export function ReviewCard({
  ...
  return (
    <div
      ...
      {/* STAR Method Notes */}
      {hasStarNotes && (
        <div className="space-y-3 rounded-lg border border-slate-100 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950">
          ...
          {review.actionNote && (
            <div>
              ...
              <p className="mt-1 text-sm text-slate-700 dark:text-slate-200">{review.actionNote}</p>
            </div>
          )}
          {review.resultNote && (
            <div>
              ...
              <p className="mt-1 text-sm text-slate-700 dark:text-slate-200">{review.resultNote}</p>
            </div>
          )}
        </div>
      )}
      ...
      {hasAdditionalNotes && (
        <div className="grid gap-3 sm:grid-cols-3">
          {review.strength && (
            <div className="rounded-lg border border-emerald-100 bg-emerald-50 p-3 dark:border-emerald-800 dark:bg-emerald-950">
          ...
          {review.weakness && (
            <div className="rounded-lg border border-amber-100 bg-amber-50 p-3 dark:border-amber-800 dark:bg-amber-950">
          ...
          {review.improve && (
            <div className="rounded-lg border border-sky-100 bg-sky-50 p-3 dark:border-sky-800 dark:bg-sky-950">
