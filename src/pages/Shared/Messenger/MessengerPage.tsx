                ...
                {!showMentorList ? (
                  currentRole === "USER" && (
                    <Button
                      variant="outline"
                      size="icon"
                      className="h-9 w-9 rounded-xl border-indigo-200 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:border-indigo-500/45 dark:bg-indigo-500/15 dark:text-indigo-300"
                  ...
                  <Button
                    variant="outline"
                    size="icon"
                    className="h-9 w-9 rounded-xl border-slate-200 bg-slate-50 text-slate-600 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
              ...
              <>
                    ...
                    <div className="flex min-w-0 items-center gap-2.5 md:gap-3">
                      {isMobile && (
                        <Button
                          variant="outline"
                          size="icon"
                          className="h-9 w-9 shrink-0 rounded-xl border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-800"
                      ...
                      {isMessageSearchOpen && (
                        <div className={cn("relative", isMobile ? "w-36" : "w-56 lg:w-72")}>
                          <Input
                            ...
                            className="h-9 rounded-xl border-slate-200 bg-slate-50 pr-8 text-xs focus-visible:border-indigo-500 focus-visible:ring-indigo-500/20 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
                          ...
                          {messageSearchQuery.trim().length > 0 && (
                            <button
                              ...
                              className="absolute top-1/2 right-2 -translate-y-1/2 text-slate-400 transition-colors hover:text-slate-600 dark:hover:text-slate-200">
                ...
                {pinnedMessage && (
                  <div className="border-b border-slate-200 bg-amber-50/50 px-4 py-2.5 md:px-6 dark:border-slate-800 dark:bg-amber-950/20">
                    <div className="mx-auto flex w-full max-w-5xl items-start gap-2 rounded-xl border border-amber-200/80 bg-white px-3 py-2.5 text-slate-900 dark:border-amber-900/70 dark:bg-slate-900 dark:text-slate-100">
                        ...
                        {hasMoreMessageHistory && (
                          <div className="mx-auto mb-2">
                            <Button
                              variant="outline"
                              size="sm"
                              className="h-8 rounded-full border-slate-200 bg-white text-xs text-slate-600 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800"
                              onClick={() =>
