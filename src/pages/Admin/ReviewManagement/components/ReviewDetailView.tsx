...
export function ReviewDetailView({ review, onBack, onDelete }: ReviewDetailViewProps) {
  ...
  return (
    <div className="animate-in fade-in space-y-6 duration-300">
      ...
      <div className="flex flex-col gap-3.5 rounded-[20px] border border-slate-200/90 bg-white p-5 shadow-xs sm:p-6 dark:border-slate-800/80 dark:bg-slate-900">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
        ...
        <div className="min-w-0 flex-1 space-y-6">
          {/* Rating Hero Card */}
          <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border border-slate-200/90 bg-white p-6 shadow-xs sm:flex-row dark:border-slate-800/80 dark:bg-slate-900">
            <div className="flex items-center gap-4">
              <div className="flex h-13 w-13 items-center justify-center rounded-2xl border border-amber-200/80 bg-amber-50/90 text-amber-500 dark:border-amber-900/50 dark:bg-amber-950/60 dark:text-amber-400">
              ...
              <div>
                ...
                <p className="mt-1 text-xs font-medium text-slate-500 dark:text-slate-400">
                  Đánh giá vào {formattedDate} bởi Mentor{" "}
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-white p-6 shadow-xs dark:border-slate-800/80 dark:bg-slate-900">
            <h3 className="mb-5 flex items-center gap-2 border-b border-slate-100 pb-3 text-sm font-bold text-slate-900 dark:border-slate-800/60 dark:text-white">
            ...
            <div className="space-y-4">
              {review.situationNote && (
                <div className="rounded-xl border border-slate-200/80 bg-slate-50/60 p-4 dark:border-slate-800/80 dark:bg-slate-950/40">
                  <div className="mb-2 flex items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200/90 bg-white px-2.5 py-1 text-xs font-bold text-slate-800 shadow-2xs dark:border-slate-700/80 dark:bg-slate-900 dark:text-slate-200">
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-white p-6 shadow-xs dark:border-slate-800/80 dark:bg-slate-900">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              {review.strength && (
                <div className="rounded-xl border border-slate-200/80 bg-slate-50/60 p-4 dark:border-slate-800/80 dark:bg-slate-950/40">
                  <div className="mb-2 flex items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-200/80 bg-emerald-50/80 px-2.5 py-1 text-xs font-bold text-emerald-700 dark:border-emerald-900/50 dark:bg-emerald-950/60 dark:text-emerald-300">
              ...
              {review.weakness && (
                <div className="rounded-xl border border-slate-200/80 bg-slate-50/60 p-4 dark:border-slate-800/80 dark:bg-slate-950/40">
                  <div className="mb-2 flex items-center gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-lg border border-rose-200/80 bg-rose-50/80 px-2.5 py-1 text-xs font-bold text-rose-700 dark:border-rose-900/50 dark:bg-rose-950/60 dark:text-rose-300">
            ...
            {review.improve && (
              <div className="mt-4 rounded-xl border border-slate-200/80 bg-slate-50/60 p-4 dark:border-slate-800/80 dark:bg-slate-950/40">
                <div className="mb-2 flex items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 rounded-lg border border-indigo-200/80 bg-indigo-50/80 px-2.5 py-1 text-xs font-bold text-indigo-700 dark:border-indigo-900/50 dark:bg-indigo-950/60 dark:text-indigo-300">
        ...
        <div className="w-full shrink-0 space-y-5 lg:w-[320px] xl:w-[350px]">
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-xs dark:border-slate-800/80 dark:bg-slate-900">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between rounded-xl bg-slate-50/80 p-3 dark:bg-slate-950/50">
                <span className="text-xs font-medium text-slate-500 dark:text-slate-400">
                  Mã phiên (Session ID)
                </span>
