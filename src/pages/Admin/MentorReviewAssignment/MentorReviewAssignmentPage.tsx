      ...
      <DialogContent className="max-h-[92vh] w-[95vw] gap-0 overflow-hidden rounded-2xl border border-slate-200/90 p-0 shadow-2xl sm:max-w-4xl dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="flex max-h-[calc(92vh-130px)] flex-col gap-4 overflow-y-auto bg-slate-50/70 p-5 dark:bg-slate-950/50">
          ...
          <div className="grid min-h-[400px] grid-cols-1 items-start gap-4 lg:grid-cols-12">
            ...
            <div className="flex max-h-[460px] flex-col gap-3 rounded-2xl border border-slate-200/90 bg-white p-4 shadow-2xs lg:col-span-5 dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="h-9 rounded-xl border-slate-200 pl-8.5 text-xs dark:border-slate-800 dark:bg-slate-950/60"
                />
              </div>
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          isChecked
                            ? "border-2 border-indigo-600 bg-indigo-50/80 shadow-xs dark:border-indigo-500 dark:bg-indigo-950/70"
                            : isPreviewing
                              ? "border-slate-300 bg-slate-100/80 dark:border-slate-700 dark:bg-slate-800/80"
                              : "border-slate-200/80 bg-slate-50/50 hover:border-slate-300 hover:bg-slate-100/60 dark:border-slate-800/70 dark:bg-slate-950/40 dark:hover:border-slate-700 dark:hover:bg-slate-800/60"
                        )}>
                        <Checkbox
                          checked={isChecked}
            ...
            <div className="flex min-h-[460px] flex-col gap-4 rounded-2xl border border-slate-200/90 bg-white p-5 shadow-2xs lg:col-span-7 dark:border-slate-800 dark:bg-slate-900">
              {previewMentor ? (
                <div className="flex flex-1 flex-col gap-4">
                  ...
                  <div className="mt-auto border-t border-slate-100 pt-3 dark:border-slate-800">
                    ...
                    <Textarea
                      ...
                      rows={2}
                      className="mt-1.5 resize-none rounded-xl border-slate-200/90 text-xs dark:border-slate-800 dark:bg-slate-950/60"
                    />
                  </div>
                </div>
              ) : (
        ...
        <div className="flex items-center justify-between gap-3 border-t border-slate-200/80 bg-white p-4 px-5 dark:border-slate-800 dark:bg-slate-900">
          <Button
            type="button"
            variant="ghost"
