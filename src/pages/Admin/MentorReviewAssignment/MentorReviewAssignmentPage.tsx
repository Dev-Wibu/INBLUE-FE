          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-[14.5px] text-slate-500 dark:text-slate-400">
      ...
      <div className="bg-transparent p-4 sm:px-6 sm:py-6">
        {isLoading ? (
          ...
          <div className="space-y-3">
            <div className="border-border overflow-hidden rounded-2xl border bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
              {/* Table header */}
