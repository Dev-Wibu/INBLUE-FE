  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-h-[92vh] w-[95vw] gap-0 overflow-hidden rounded-2xl border border-slate-200/90 p-0 shadow-2xl sm:max-w-4xl dark:border-slate-800 dark:bg-slate-900">
        {/* Distinct Header with Elevated Background */}
        <DialogHeader className="border-b border-slate-200/80 bg-slate-50/90 p-4.5 px-6 dark:border-slate-800 dark:bg-slate-900">
          <div className="flex flex-wrap items-center justify-between gap-3">
            {/* Left: Candidate Profile Info */}
            <div className="flex items-center gap-3">
            ...
            {detail && (
              <div className="flex flex-wrap items-center gap-2">
                <div className="flex items-center gap-2 rounded-xl border border-slate-200/90 bg-white px-3 py-1.5 dark:border-slate-700/80 dark:bg-slate-800">
        ...
        {/* Full-Bleed 2-Column Body (No Outer Body Card Borders!) */}
        <div className="grid max-h-[calc(92vh-130px)] min-h-[420px] grid-cols-1 divide-x divide-slate-100 overflow-hidden bg-white lg:grid-cols-12 dark:divide-slate-800/80 dark:bg-slate-950">
          {/* LEFT COLUMN (5/12) - Search & Scrollable Mentor List */}
          <div className="flex flex-col gap-3 bg-white p-4 lg:col-span-5 dark:bg-slate-950">
            ...
            <div className="relative">
              ...
              <Input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="h-9 rounded-xl border-slate-200 pl-8.5 text-xs dark:border-slate-800 dark:bg-slate-900"
              />
            </div>
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isChecked
                          ? "border-indigo-600 bg-indigo-50/70 shadow-2xs dark:border-indigo-500 dark:bg-indigo-950/60"
                          : isPreviewing
                            ? "border-slate-300 bg-slate-100/70 dark:border-slate-700 dark:bg-slate-900"
          ...
          <div className="flex max-h-[440px] flex-col overflow-y-auto bg-white p-5 lg:col-span-7 dark:bg-slate-950">
            {previewMentor ? (
              <div className="flex flex-1 flex-col gap-4">
                ...
                <div className="mt-auto border-t border-slate-100 pt-3 dark:border-slate-800">
                  ...
                  <Textarea
                    ...
                    rows={2}
                    className="mt-1.5 resize-none rounded-xl border-slate-200/90 text-xs dark:border-slate-800 dark:bg-slate-900"
                  />
                </div>
              </div>
            ) : (
        ...
        {/* Distinct Footer with Elevated Background Shading */}
        <div className="flex items-center justify-between gap-3 border-t border-slate-200/80 bg-slate-50/90 p-4 px-6 dark:border-slate-800 dark:bg-slate-900">
          <Button
            type="button"
            variant="ghost"
