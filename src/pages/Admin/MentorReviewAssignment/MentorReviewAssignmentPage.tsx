    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-4xl">
        ...
        <div className="grid gap-6 py-4 lg:grid-cols-3">
          {/* Candidate info - spans 2 columns */}
          {detail && (
            <div className="rounded-lg border bg-white p-4 lg:col-span-2 dark:border-slate-700 dark:bg-slate-900">
              ...
              <div className="flex items-start gap-4">
                {/* Avatar */}
                <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-full bg-slate-100 text-xl font-bold text-slate-600 dark:bg-slate-800 dark:text-slate-300">
                  {detail.candidateAvatarUrl ? (
                    <img
