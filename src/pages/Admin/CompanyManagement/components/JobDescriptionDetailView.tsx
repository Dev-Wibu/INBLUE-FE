                    ...
                    <div key={index} className="flex shrink-0 items-stretch gap-2.5">
                      <div
                        ...
                        {/* Reviewer row — visible when staffUsers have loaded.
                            Quiz rounds are auto-graded (no human reviewer), so the
                            entire reviewer row is hidden for QUIZ. Other round types
                            show the reviewer (or "Not assigned") and a Change button. */}
                        {staffUsers.length > 0 && round.roundType !== "QUIZ" && (
