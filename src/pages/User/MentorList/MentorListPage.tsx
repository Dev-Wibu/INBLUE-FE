...
export function MentorListPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#F8FAFC] p-6 md:p-12 lg:p-20 dark:bg-slate-950">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="mb-16 flex flex-col gap-4 text-center md:text-left">
          <div className="inline-flex w-fit items-center gap-2 rounded-full bg-blue-50 px-4 py-1.5 text-xs font-bold tracking-widest text-blue-600 uppercase dark:bg-blue-900/20">
          ...
          <p className="max-w-xl text-lg leading-relaxed font-medium text-slate-500 dark:text-slate-400">
            Những chuyên gia hàng đầu sẵn sàng chia sẻ kiến thức, kinh nghiệm và thắp sáng con đường
            sự nghiệp của bạn.
          </p>
        </div>
        ...
        <div className="mb-20 flex w-full max-w-2xl items-center rounded-2xl bg-white p-2 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-slate-100 transition-all focus-within:ring-blue-400 dark:bg-slate-900 dark:ring-slate-800">
          ...
          <Input
            ...
            className="h-12 border-none bg-transparent text-lg placeholder:text-slate-300 focus-visible:ring-0"
            value={searchQuery}
                  ...
                  <div className="flex flex-1 flex-col p-2">
                    <div className="mb-6 flex flex-col items-center justify-between gap-4 md:flex-row md:items-start">
                      <div className="text-center md:text-left">
                        ...
                        <p className="mt-1 flex items-center justify-center gap-2 text-sm font-bold tracking-widest text-indigo-500 uppercase md:justify-start">
                          <CheckCircle2 className="h-4 w-4" />
                    ...
                    <div className="mb-8 flex flex-col gap-2">
                      <div className="flex items-center gap-2 font-bold text-slate-400">
                        ...
                        <span className="text-slate-600 dark:text-slate-300">
                          {mentor.currentCompany || "Đại diện tự do"}
                        </span>
                      </div>
                      <p className="line-clamp-2 text-lg leading-relaxed font-medium text-slate-500 dark:text-slate-400">
                        {mentor.bio ||
                          "Mang đến giải pháp và định hướng chuyên nghiệp cho sự vươn tầm của các thế hệ trẻ."}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <button className="hidden items-center gap-2 text-sm font-bold text-slate-400 transition-colors hover:text-slate-900 md:flex dark:hover:text-white">
                        Xem hồ sơ chi tiết
