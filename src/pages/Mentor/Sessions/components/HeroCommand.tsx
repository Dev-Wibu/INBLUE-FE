      ...
      <div className="relative grid gap-4 p-5 sm:grid-cols-[1fr_auto] sm:items-start sm:gap-6 sm:p-6">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 ring-1 ring-white/10 ring-inset">
              <Radio className="h-4 w-4 text-sky-300" aria-hidden />
            </div>
          ...
          {upNext ? (
            <div
              ...
              <div className="relative mt-1 flex items-center gap-2">
                <span className="inline-flex items-center gap-1 rounded-full bg-sky-500/15 px-2 py-0.5 text-[11px] font-medium text-sky-200 ring-1 ring-sky-400/30 ring-inset">
